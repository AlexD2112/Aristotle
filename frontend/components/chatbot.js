...
export default function Chatbot({ onStartQuiz }) {
        ...
        const handleFileUpload = async (e) => {
          ...
          return (
            <div className="chatbot-container">
              ...
              {userData.topics.length > 0 && onStartQuiz && (
                <div className="quiz-start" style={{ marginTop: '20px', textAlign: 'center' }}>
                  <button 
                    onClick={() => onStartQuiz(userData.topics.join(', '))}
                    style={{
                      padding: '15px 30px',
                  ...
                  >
                    🎯 Start Quiz: {userData.topics.join(', ')}
                  </button>
                </div>
              )}
            </div>
